...
class TvShowAdapter internal constructor(): PagedListAdapter<TvEntitys, TvShowAdapter.TvViewHolder>(
    DIFF_CALLBACK
) {
    ...
    inner class TvViewHolder(itemView: View) :RecyclerView.ViewHolder(itemView){
        fun bind(TvShow: TvEntitys?){
            with(itemView){
                ...
                Glide.with(context)
                    .load(context.getString(R.string.linkPoster) + TvShow?.posterPath.toString())
