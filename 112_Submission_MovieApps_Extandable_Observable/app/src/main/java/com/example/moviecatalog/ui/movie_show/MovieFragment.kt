...
import com.example.moviecatalog.adapter.movie.MovieSearchAdapter
import com.example.moviecatalog.adapter.movie.MoviesAdapter
...
class MovieFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if(activity != null){
            ...
            val movieHorizontalAdapter = HorizontalAdapter()
