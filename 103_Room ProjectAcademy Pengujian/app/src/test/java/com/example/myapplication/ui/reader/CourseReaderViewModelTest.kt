...
class CourseReaderViewModelTest {
    ...
    fun getModules() {
        ...
        val resource = Resource.success(dummyCourse) as Resource<List<ModuleEntity>>
    ...
    /*
    * Jadi, setiap pengujian harus ditambahkan when.thenReturn untuk mendapatkan balikan yang diinginkan.
    * Karena jika tanpa when.thenReturn AcademyRepository menjadi null. Selain itu, semua LiveData dibungkus di dalam Resource.
    * */
}