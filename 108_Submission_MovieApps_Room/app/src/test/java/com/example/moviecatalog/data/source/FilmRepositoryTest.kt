...
class FilmRepositoryTest {
    ...
    @Test
    fun getAllMovies() {
        val dummyMovie = MutableLiveData<List<MovieEntitys>>()
    ...
    @Test
    fun getAllTv() {
        val dummyTv = MutableLiveData<List<TvEntitys>>()
    ...
    fun getTvDetail(){
        ...
        dummyEntity.value = DataDummy.generateDummyTvWithDetail(DataDummy.generateDetailDummyTV())
