...
interface ApiService {
    ...
    fun getSearchMovie(@Query("query") query:String):Call<MovieSearchResponse>

    @GET("search/tv?api_key=${API_KEY}&language=${LANGUAGE}")
    fun getSearchTv(@Query("query") query:String):Call<TvSearchResponse>
}
